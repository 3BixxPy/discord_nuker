...
- download discord_nuker [here](https://github.com/3BixxPy/discord_nuker/archive/refs/heads/main.zip), open CMD and navigate to your download folder with ```cd C:\your_folder```
